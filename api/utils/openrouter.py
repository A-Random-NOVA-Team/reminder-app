...
if not OPENROUTER_API_KEY:
    print("Warning: OPENROUTER_API_KEY environment variable not set. Using default score.")
...
class TaskDifficultySchema(BaseModel):
    ...
    reasoning: str | None = Field(
        None,
        description="Brief explanation of why this difficulty was chosen."
    )

## 📞 OpenRouter API Caller Function

async def estimate_task_difficulty_full(task_name: str, task_description: str) -> TaskDifficultySchema:
    """
    ...
    payload = {
        ...
        "messages": [
            ...
            {"role": "user", "content": f"Analyze the task and determine its difficulty score (0-100) and provide reasoning."}
        ],
